...
uint8_t i2c1_is_device_ready(uint16_t dev_read_addres){
	...
	i2c_device = HAL_I2C_IsDeviceReady(&I2C_HandleStruct, dev_read_addres , 10,100);
...
uint8_t write_mem(uint16_t dev_adr,uint16_t mem_adr,uint16_t mem_size, uint8_t *data, uint16_t size){
	...
	return HAL_I2C_Mem_Write(&I2C_HandleStruct, dev_adr, mem_adr, mem_size,data, size,100);
}
/*
 ===========================================================================================================================================================================
